...
import net.meshcollision.wallet.AddressBookProvider;
import net.meshcollision.wallet.Configuration;
import net.meshcollision.wallet.Constants;
import net.meshcollision.wallet.ExchangeRatesProvider;
import net.meshcollision.wallet.ExchangeRatesProvider.ExchangeRate;
import net.meshcollision.wallet.PaymentIntent;
import net.meshcollision.wallet.PaymentIntent.Standard;
import net.meshcollision.wallet.WalletApplication;
import net.meshcollision.wallet.integration.android.BitcoinIntegration;
import net.meshcollision.wallet.offline.DirectPaymentTask;
import net.meshcollision.wallet.ui.InputParser.BinaryInputParser;
import net.meshcollision.wallet.ui.InputParser.StreamInputParser;
