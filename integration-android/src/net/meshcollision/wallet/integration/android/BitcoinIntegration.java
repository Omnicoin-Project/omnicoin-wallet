...
package net.meshcollision.wallet.integration.android;
...
public final class BitcoinIntegration
{
	...
	private static final String MIMETYPE_PAYMENTREQUEST = "application/omnicoin-paymentrequest"; // BIP 71
	...
	{
		final StringBuilder uri = new StringBuilder("omnicoin:");
		if (address != null)
			uri.append(address);
		if (amount != null)
